...
@SetUp(skipped = false)
def setUp() {
	// Publish UAT only. Clears the PRUAdvisers tab. Leaves Discovery, Custom pages, Contact Us, and preflight in place.
	PacsRegressionReportBuilder.startPRUAdvisersRun()
}
