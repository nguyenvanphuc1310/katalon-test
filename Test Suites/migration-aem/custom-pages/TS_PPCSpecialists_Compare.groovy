...
@SetUp(skipped = false)
def setUp() {
	// Publish UAT only. Clears the PPC Specialists tab. Leaves the Custom pages PPC Extended Panel tab in place.
	PacsRegressionReportBuilder.startPpcSpecialistsRun()
}
