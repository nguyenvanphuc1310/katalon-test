...
| [reference/](reference/) | Stable reference: verdicts, the score the verdict is banded on, the contract `ReportBuilder` reads, and the unimplemented JSON contract |
...
4. [reference/verdicts-and-score.md](reference/verdicts-and-score.md) — what each verdict means, the weights, and the band the verdict is decided by.
