...
/*
 * Parent test for the "General Content Detail Page" page type (normal-pages).
 *
 ...
 *
 * The suite binds Data Files/url-mapping/normal-pages/general-content-detail-page.csv; the pagetype guard below is a
 * safety net for the case where a wider data file is ever bound to this test case.
 */

if (pagetype != 'general-content-detail-page') {
...
KeywordUtil.logInfo("=== ${mode.toUpperCase()} | General Content Detail Page | ${pageurl} ===")
